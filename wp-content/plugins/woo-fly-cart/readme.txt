...
= 5.4.7 =
* Added: Compatible with WPC Estimated Delivery Date

= 5.4.6 =
* Fixed: Prevent reloading the page when installing a new plugin

= 5.4.5 =
* Fixed: Add link for suggested products

= 5.4.4 =
* Fixed: Compatible with WPC Smart Messages

= 5.4.3 =
* Fixed: Minor JS issue

= 5.4.2 =
* Fixed: Can't change the shipping method

= 5.4.1 =
* Fixed: Minor JS issues in the backend

= 5.4.0 =
* Added: Option to enable/disable carousel for suggested products
...
= 5.3.1 =
* Added: Append cart contents count to the heading
* Added: Filter hook 'woofc_styles' & 'woofc_default_style'
...
= 5.2.1 =
* Added: Option to show/hide plus and minus button
* Added: Option to show/hide the remove button on each item
